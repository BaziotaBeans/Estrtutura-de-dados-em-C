...
*/
/* -------------------------------------------------------------------------------------------------------
Especificação do Interface : listaDuplamenteLigada.h
Objectivo: Disponibilizar as operações comuns sobre uma lista Duplamente Ligada
--------------------------------------------------------------------------------------------------------*/
#ifndef LISTALIGDUPLIG_H_INCLUDED
#define LISTALIGDUPLIG_H_INCLUDED
